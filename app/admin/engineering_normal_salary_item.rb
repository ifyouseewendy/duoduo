ActiveAdmin.register EngineeringNormalSalaryItem do
  ...
  member_action :update, method: :post do
    ...
    begin
      ...
      obj.update! attrs
      redirect_to "/engineering_normal_with_tax_salary_items?utf8=✓&q%5Bsalary_table_id_eq%5D=#{obj.engineering_salary_table_id}&commit=过滤", notice: "成功更新工资条<#{obj.staff.name}>"
    rescue => e
      redirect_to "/engineering_normal_with_tax_salary_items?utf8=✓&q%5Bsalary_table_id_eq%5D=#{obj.engineering_salary_table_id}&commit=过滤", alert: "更新失败，#{e.message}"
    end
  end
